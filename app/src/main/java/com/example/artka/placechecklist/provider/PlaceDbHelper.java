...
public class PlaceDbHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "placechecklist.db";
    ...
    public void onCreate( SQLiteDatabase db) {
        ...
        final String SQL_CREATE_PLACES_TABLE = "CREATE TABLE " + PlaceContract.PlaceEntry.TABLE_NAME + " (" +
                ...
                PlaceContract.PlaceEntry.COLUMN_PLACE_ADDRESS + " TEXT NOT NULL, " +
                PlaceContract.PlaceEntry.COLUMN_PLACE_NAME + " TEXT NOT NULL, " +
                PlaceContract.PlaceEntry.COLUMN_PLACE_LATLONG + " TEXT NOT NULL, " +
